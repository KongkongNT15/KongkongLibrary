...
#include "Definitions/Kongkong.Numeric.DynamicVector.h"
#include "Definitions/Kongkong.Numeric.Equation2.h"
#include "Definitions/Kongkong.Numeric.Math.h"
#include "Definitions/Kongkong.Numeric.Matrix.h"
