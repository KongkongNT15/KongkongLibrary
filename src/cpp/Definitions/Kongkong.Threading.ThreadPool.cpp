...
#ifdef KONGKONG_ENV_WINDOWS
                _s.h = h;
                ::PTP_WORK work = ::CreateThreadpoolWork(_callback2<TFArg, TValue>, &_s, nullptr);
...
#ifdef KONGKONG_ENV_WINDOWS
                _s.h = h;
                ::PTP_WORK work = ::CreateThreadpoolWork(_callback3<TFArg, TValue>, &_s, nullptr);
